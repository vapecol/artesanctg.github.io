...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function cargarProductos() {
    ...
    data.products.forEach(producto => {
      ...
      const precioUSD = (producto.price_cop / 4000).toFixed(0);

      catalogueGrid.innerHTML += `
        <div class="product-card">

          <img src="${producto.image}" alt="${producto.name.es}">

          <h3>${producto.name[currentLang]}</h3>

          <p class="price">
            COP $${producto.price_cop.toLocaleString()} / USD $${precioUSD}
          </p>

          <div class="botones-compra">

            <a href="https://wa.me/${producto.whatsapp}" target="_blank">
              <button class="whatsapp">
                <i class="fab fa-whatsapp"></i>
              </button>
            </a>

            <a href="${producto.stripe}" target="_blank">
